...
// Для создания новой карточки нужно сделать отдельную функцию getCard ,
// чтобы не дублировать код и разделить логику вставки: она будет возвращать готовую карточку
// с уже установленными обработчиками через return, а вставлять в DOM там не нужно.
...
// Краткая запись. Для каждого элемента массива запустить функцию, где аргумент - элемент массива.
initialCards.forEach(createCard);

// 🟢 Слушатель кнопки открытыя попапа добавления места
addPlaceBtn.addEventListener("click", (evt) => {
  formElementAddPlace.reset(); // сначала очищается форма
